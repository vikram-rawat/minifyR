...
#' @param asset_output_file string: defining the file name from where the minified bundle will be put or you can define an environment variable called `minify_output_path`
